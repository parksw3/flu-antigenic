...
load("../simulation/simulation_flu_ode_1year.rda")

n <- 300

simulation_all <- list(
  simulation_flu_ode_1year_base,
...
ggsave("figure_flu_ode_1year_1.pdf", g1, width=12, height=3)
ggsave("figure_flu_ode_1year_1.png", g1, width=12, height=3)
...
ggsave("figure_flu_ode_1year_2.pdf", g2, width=12, height=3)
ggsave("figure_flu_ode_1year_2.png", g2, width=12, height=3)
...
ggsave("figure_flu_ode_1year_3.pdf", g3, width=12, height=6)
ggsave("figure_flu_ode_1year_3.png", g3, width=12, height=6)
...
ggsave("figure_flu_ode_1year_4.pdf", g4, width=12, height=6)
...
ggsave("figure_flu_ode_1year_5.pdf", g5, width=12, height=6)
